...
public class TestBufferedInput {
  ...
  private static final int BUFFER = 1024*1024; // BufferedInput uses a 512KiB buffer

  private String codec;
  private String checksum;

  public TestBufferedInput(String codec, String checksum) throws IOException {
    this.codec = codec;
  ...
  @Test public void testEmptyFile() throws Exception {
    ...
    ColumnFileReader in = new ColumnFileReader(
        new BufferedInput(new InputFile(FILE), BUFFER));
